...
class OrderPayView(View):
    ...
    def post(self, request):
        ...
        # 初始化
        alipay = AliPay(
            appid="2016092600597794",  # 应用id
            app_notify_url=None,  # 默认回调url
            app_private_key_path=os.path.join(settings.BASE_DIR, 'apps/order/app_private_key.pem'),
            alipay_public_key_path=os.path.join(settings.BASE_DIR, 'apps/order/ali_pubilc_key.pem'),  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
...
class CheckPayView(View):
    ...
    def post(self, request):
        ...
        alipay = AliPay(
            ...
            app_notify_url=None,  # 默认回调url
            app_private_key_path=os.path.join(settings.BASE_DIR, 'apps/order/app_private_key.pem'),
            alipay_public_key_path=os.path.join(settings.BASE_DIR, 'apps/order/ali_pubilc_key.pem'),
